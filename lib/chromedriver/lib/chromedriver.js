...
const configuredFilePath = process.env.npm_config_chromedriver_binary_filepath || process.env.CHROMEDRIVER_BINARY_FILEPATH;
if (configuredFilePath) {
  console.log('Using configured file path for chromedriver binary: ' + configuredFilePath);
